...
def run_linting() -> bool:
    ...
    flake8_success = run_command(
        ["python3", "-m", "flake8", "pathwaylens_core/", "pathwaylens_cli/"],
        "Flake8 Linting"
    )
    
    # Run black check
    black_success = run_command(
        ["python3", "-m", "black", "--check", "pathwaylens_core/", "pathwaylens_cli/"],
        "Black Formatting Check"
    )
    
    # Run isort check
    isort_success = run_command(
        ["python3", "-m", "isort", "--check-only", "pathwaylens_core/", "pathwaylens_cli/"],
...
def run_type_checking() -> bool:
    ...
    cmd = ["python3", "-m", "mypy", "pathwaylens_core/", "pathwaylens_cli/"]
...
def main():
    ...
    # Change to project root directory (two levels up from scripts/tests/)
