...
class TestAPIEndpoints:
    ...
    def test_analyze_endpoint_invalid_data(self, client):
    ...
    @pytest.mark.asyncio
    async def test_compare_endpoint_success(self, client):
        """Test successful compare endpoint call."""
    ...
    def test_compare_endpoint_invalid_data(self, client):
    ...
    @pytest.mark.asyncio
    async def test_visualize_endpoint_success(self, client):
        """Test successful visualize endpoint call."""
    ...
    def test_visualize_endpoint_invalid_data(self, client):
        """Test visualize endpoint with invalid data."""
        response = client.post("/visualize", json={
            "input_data": None,
    ...
    @pytest.mark.asyncio
    async def test_normalize_endpoint_success(self, client):
        """Test successful normalize endpoint call."""
    ...
    def test_normalize_endpoint_invalid_data(self, client):
        """Test normalize endpoint with invalid data."""
        response = client.post("/normalize", json={
            "input_data": None,
    ...
    def test_job_status_endpoint_success(self, client):
        """Test successful job status endpoint call."""
    ...
    def test_job_result_endpoint_success(self, client):
        """Test successful job result endpoint call."""
    ...
    def test_job_result_endpoint_not_found(self, client):
        """Test job result endpoint with non-existent job."""
        with patch('pathwaylens_api.utils.database.get_job_result') as mock_get_result:
            mock_get_result.return_value = None
            
            response = client.get("/jobs/non-existent-job/result")
            assert response.status_code == 404
